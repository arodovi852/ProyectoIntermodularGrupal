...
export const handlers = [
  rest.post('http://broadcastts.com/api/v1/login', async (req, res, ctx) => {
  ...
  rest.post('http://broadcastts.com/api/v1/register', async (req, res, ctx) => {
  ...
  rest.get('http://broadcastts.com/api/v1/user', (req, res, ctx) => {
